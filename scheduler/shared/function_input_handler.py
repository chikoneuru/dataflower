        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    ce_str = str(ce)
                    if ('BucketAlreadyOwnedByYou' in ce_str) or ('BucketAlreadyExists' in ce_str):
                        self.logger.info(f"MinIO bucket {self.minio_bucket} already exists/owned; proceeding")
                    else:
                        raise ce
