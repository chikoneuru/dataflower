...
@dataclass
class StaticProfilingConfig:
    """Configuration for Static Profiling component"""
    enabled: bool = True
    profiles_dir: str = "results/static_profiles"
    profile_name: str = "default"
    auto_load: bool = True
    fallback_to_heuristic: bool = True
    
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "StaticProfilingConfig":
        return cls(**{k: v for k, v in data.items() if hasattr(cls, k)})
...
class SystemConfig:
    ...
    static_profiling: StaticProfilingConfig = None
    ...
    def __post_init__(self):
        ...
        if self.static_profiling is None:
            self.static_profiling = StaticProfilingConfig()
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "SystemConfig":
        return cls(
            ...
            static_profiling=StaticProfilingConfig.from_dict(data.get("static_profiling", {})),
...
# Initializer
def load_config(preset: str = "simple"):
    global _config
    if preset in ["development", "simple"]:
        _config = ConfigPresets.get_development_config()
    elif preset == "production":
        _config = ConfigPresets.get_production_config()
    elif preset in ["testing", "mock"]:
