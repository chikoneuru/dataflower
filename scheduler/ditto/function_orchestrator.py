...
class FunctionOrchestrator:
    ...
    def invoke_function(self, function_name: str, request_id: str, payload: bytes, worker: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        response = self._send_request_to_worker(worker, function_name, request_id, payload)
    ...
    def _send_request_to_worker(self, worker: Dict, function_name: str, request_id: str, body: Any) -> Dict:
        """Send request with data payload to a discovered worker container."""
        ...
        try:
            self.logger.debug(f"    - Sending direct request to {url}")
