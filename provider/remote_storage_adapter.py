...
from .data_manager import DataMetadata, DataAccessRequest
...
class MinIOStorageAdapter(RemoteStorageAdapter):
    ...
    def __init__(self, config: Dict = None):
        ...
        self.minio_config = {
            **self.config,
            'aws_access_key_id': self.config.get('access_key', 'dataflower'),
            'aws_secret_access_key': self.config.get('secret_key', 'dataflower123'),
        ...
        # Get bucket name
        self.bucket_name = self.config.get('bucket_name', 'dataflower-storage')
