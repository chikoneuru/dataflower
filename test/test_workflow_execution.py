...
def main(args):
    ...
    mode_classifier = ModeClassifier(threshold=1.0)
    ...
    scheduler = Scheduler(cost_models, mode_classifier, container_manager, function_manager)
    orchestrator = Orchestrator(scheduler, function_manager)
